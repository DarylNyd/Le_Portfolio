...
const Index = () => {
  ...
  return (
    ...
    >
      ...
      <AnimatedText text="My Projects as a Front-end" className='!text-5xl' />
      ...
      <div className='h-screen'>
      <AnimatedText text="My Projects as a UI/UX Designer" className='!text-5xl' />
      <div className="grid grid-cols-3 mt-10 mb-10">
      {Projects2.map((project2, index) => (
          <ProjectCard2
              key={index}
      ...
      <div className='h-screen'>
      <AnimatedText text="My Projects as an Artist" className='!text-5xl' />
      <motion.div className="grid grid-cols-3 mt-10 mb-10" variants={slideInFromBottom} initial="hidden" animate="visible">
      {Projects2.map((project2, index) => (
          <ArtsCard
              key={index}
              title={project2.title}
    ...
    <div className="w-screen h-screen flex flex-col gap-16 items-center justify-center text-center">
        ...
        <motion.div className="relative" variants={slideInFromLeft} initial="hidden" animate="visible">
          <motion.svg
            animate={{ rotate: 360 }}
